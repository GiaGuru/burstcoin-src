...
/* 10:   */ 
/* 11:   */ public final class GetPollIds
/* 12:   */   extends APIServlet.APIRequestHandler
/* 13:   */ {
/* 14:14 */   static final GetPollIds instance = new GetPollIds();
/* 15:   */   
/* 16:   */   private GetPollIds()
/* 17:   */   {
/* 18:17 */     super(new APITag[] { APITag.VS }, new String[] { "firstIndex", "lastIndex" });
/* 19:   */   }
/* 20:   */   
...
/* 27:27 */     Object localObject1 = Poll.getAllPolls(i, j);Object localObject2 = null;
/* 28:   */     try
/* 29:   */     {
/* 30:28 */       while (((DbIterator)localObject1).hasNext()) {
/* 31:29 */         localJSONArray.add(Convert.toUnsignedLong(((Poll)((DbIterator)localObject1).next()).getId()));
/* 32:   */       }
/* 33:   */     }
...
/* 56:33 */     ((JSONObject)localObject1).put("pollIds", localJSONArray);
 ...
 * Qualified Name:     nxt.http.GetPollIds
