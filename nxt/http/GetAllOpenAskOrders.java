...
/*  4:   */ import nxt.Order.Ask;
/*  5:   */ import nxt.db.DbIterator;
/*  6:   */ import org.json.simple.JSONArray;
/*  7:   */ import org.json.simple.JSONObject;
/*  8:   */ import org.json.simple.JSONStreamAware;
/*  9:   */ 
/* 10:   */ public final class GetAllOpenAskOrders
/* 11:   */   extends APIServlet.APIRequestHandler
/* 12:   */ {
/* 13:13 */   static final GetAllOpenAskOrders instance = new GetAllOpenAskOrders();
/* 14:   */   
/* 15:   */   private GetAllOpenAskOrders()
/* 16:   */   {
...
/* 27:   */     
/* 28:28 */     DbIterator localDbIterator = Order.Ask.getAll(i, j);Object localObject1 = null;
/* 29:   */     try
/* 30:   */     {
/* 31:29 */       while (localDbIterator.hasNext()) {
/* 32:30 */         localJSONArray.add(JSONData.askOrder((Order.Ask)localDbIterator.next()));
/* 33:   */       }
/* 34:   */     }
 ...
 * Qualified Name:     nxt.http.GetAllOpenAskOrders
