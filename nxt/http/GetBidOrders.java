...
/* 30:28 */     Object localObject1 = Order.Bid.getSortedOrders(l, i, j);Object localObject2 = null;
/* 31:   */     try
/* 32:   */     {
/* 33:29 */       while (((DbIterator)localObject1).hasNext()) {
/* 34:30 */         localJSONArray.add(JSONData.bidOrder((Order.Bid)((DbIterator)localObject1).next()));
/* 35:   */       }
/* 36:   */     }
...
/* 56:   */       }
/* 57:   */     }
/* 58:33 */     localObject1 = new JSONObject();
/* 59:34 */     ((JSONObject)localObject1).put("bidOrders", localJSONArray);
/* 60:35 */     return (JSONStreamAware)localObject1;
/* 61:   */   }
/* 62:   */ }


/* Location:           E:\java decompi;er\burst.jar
 * Qualified Name:     nxt.http.GetBidOrders
