...
/* 14:   */ 
/* 15:   */ public final class GetTrades
/* 16:   */   extends APIServlet.APIRequestHandler
/* 17:   */ {
/* 18:18 */   static final GetTrades instance = new GetTrades();
/* 19:   */   
/* 20:   */   private GetTrades()
/* 21:   */   {
...
/* 44:40 */         localDbIterator = ((Asset)localObject1).getTrades(i, j);
/* 45:   */       }
/* 46:41 */       else if (str1 == null)
/* 47:   */       {
/* 48:42 */         localObject1 = ParameterParser.getAccount(paramHttpServletRequest);
/* 49:43 */         localDbIterator = ((Account)localObject1).getTrades(i, j);
/* 50:   */       }
/* 51:   */       else
/* 52:   */       {
...
/* 55:47 */         localDbIterator = Trade.getAccountAssetTrades(localAccount.getId(), ((Asset)localObject1).getId(), i, j);
/* 56:   */       }
/* 57:49 */       while (localDbIterator.hasNext()) {
/* 58:50 */         localJSONArray.add(JSONData.trade((Trade)localDbIterator.next(), bool));
/* 59:   */       }
/* 60:   */     }
/* 61:   */     finally
/* 62:   */     {
...
/* 64:   */     }
/* 65:55 */     localJSONObject.put("trades", localJSONArray);
/* 66:   */     
 ...
 * Qualified Name:     nxt.http.GetTrades
