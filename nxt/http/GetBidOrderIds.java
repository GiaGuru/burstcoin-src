...
/* 15:   */ {
/* 16:15 */   static final GetBidOrderIds instance = new GetBidOrderIds();
/* 17:   */   
/* 18:   */   private GetBidOrderIds()
/* 19:   */   {
...
/* 31:29 */     Object localObject1 = Order.Bid.getSortedOrders(l, i, j);Object localObject2 = null;
/* 32:   */     try
/* 33:   */     {
/* 34:30 */       while (((DbIterator)localObject1).hasNext()) {
/* 35:31 */         localJSONArray.add(Convert.toUnsignedLong(((Order.Bid)((DbIterator)localObject1).next()).getId()));
/* 36:   */       }
/* 37:   */     }
...
/* 57:   */       }
/* 58:   */     }
/* 59:34 */     localObject1 = new JSONObject();
/* 60:35 */     ((JSONObject)localObject1).put("bidOrderIds", localJSONArray);
/* 61:36 */     return (JSONStreamAware)localObject1;
/* 62:   */   }
/* 63:   */ }
